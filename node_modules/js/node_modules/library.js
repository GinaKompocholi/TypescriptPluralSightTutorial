...
var encyclopedia_1 = __importDefault(require("./encyclopedia"));
...
var purgedBooks = (0, utilityFunctions_1.Purge)(inventory);
purgedBooks.forEach(function (book) { return console.log('book.title: ' + book.title); });
var purgedNumbers = (0, utilityFunctions_1.Purge)([1, 2, 3, 4]);
...
var softwareBook = bookShelf.find('C++ advanced');
