...
import moduleEncyclopedia from './encyclopedia';
import { CalculateLateFee as CalcFee, MaxBooksAllowed, Purge} from '../moduleDemo/utilityFunctions'
...
/* Αbstract classes cant be instantiated. Can only create an instance of their subclass
...
let refBook = new moduleEncyclopedia("WordlRecords Module", 1985, 10);
refBook.printItem();
let refBook2 = new moduleEncyclopedia("WordlRecords Module2", 1985, 10);
refBook2.printCitation();
...
purgedBooks.forEach( book => console.log('book.title: '+book.title))

let purgedNumbers: Array<number> = Purge<number>([1, 2, 3, 4]);
console.log('purgedNumbers:'+purgedNumbers);
...
let magazines: Array<Magazine> = [ 
    { title: 'Vogue', publisher: 'Paris Fashion'},
    { title: 'NatGeoWild', publisher: "Nature's Best"},
];
...
let softwareBook = bookShelf.find('C++ advanced');
